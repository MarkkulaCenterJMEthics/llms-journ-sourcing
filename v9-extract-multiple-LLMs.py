...
version = "v50"
or_api_key = "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"
...
# This is the original json and csv conversion function to match the v5 prompts up until v41 
...
def process_files(input_dir, output_dir, selected_models, loop_times, prefix_string=""):
...
def main():
    ...
    process_files(input_dir, output_dir, selected_models, args.times, args.string)
